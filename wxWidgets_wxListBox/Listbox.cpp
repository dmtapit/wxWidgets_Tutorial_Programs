...
Listbox::Listbox(const wxString& title) : wxFrame(NULL, wxID_ANY, title, wxDefaultPosition, wxSize(270, 200))
{
...
MyPanel::MyPanel(wxPanel * parent) : wxPanel(parent, wxID_ANY)
{
