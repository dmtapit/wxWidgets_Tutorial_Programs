...
StaticLine::StaticLine(const wxString& title) : wxDialog(NULL, wxID_ANY, title, wxDefaultPosition, wxSize(360, 350))
{
	//wxFont font(10, wxDEFAULT, wxNORMAL, wxBOLD); // error C4996: 'wxFont::wxFont' : deprecated
	//use wxFONT{FAMILY,STYLE,WEIGHT}_XXX constants ie: wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_BOLD
	...
	//sum_font.SetWeight(wxBOLD); // deprecated (see line 7)
